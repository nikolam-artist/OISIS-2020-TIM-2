...
public AdmLekoviIzmeniPostojeci() {
	    ...
	    JLabel lekovitx = new JLabel("<html><body>Nakon unete sifre leko unesite nove vrednosti stavki.<br>Ostavite polje prazno ukoliko zelite da stavka ostane nepromenjena.</body></html>");
