...
public AdmLekoviDodajNovi() {
	    ...
	    JLabel lekovitx_1 = new JLabel("Lista lekova");
	    ...
	    JLabel lekovitx_1_1_1 = new JLabel("<HTML><U>Dodaj novi</U></HTML>");
	    lekovitx_1_1_1.setHorizontalAlignment(SwingConstants.CENTER);
	    lekovitx_1_1_1.setForeground(new Color(8, 126, 139));
	    lekovitx_1_1_1.setFont(new Font("Montserrat", Font.PLAIN, 14));
	    
	    JLabel lekovitx_1_1_1_1 = new JLabel("Izmeni postojeci");
	    lekovitx_1_1_1_1.setHorizontalAlignment(SwingConstants.CENTER);
	    lekovitx_1_1_1_1.setForeground(new Color(8, 126, 139));
	    lekovitx_1_1_1_1.setFont(new Font("Montserrat", Font.PLAIN, 14));
	    				...
	    				.addGroup(gl_panel_2.createSequentialGroup()
	    					...
	    					.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
	    						...
	    						.addGroup(gl_panel_2.createSequentialGroup()
	    							...
	    							.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
	    								.addGroup(gl_panel_2.createSequentialGroup()
	    									.addComponent(lekovitx_1_1_1, GroupLayout.PREFERRED_SIZE, 86, GroupLayout.PREFERRED_SIZE)
	    									.addPreferredGap(ComponentPlacement.RELATED)
	    									.addComponent(lekovitx_1_1_1_1, GroupLayout.PREFERRED_SIZE, 125, GroupLayout.PREFERRED_SIZE))
	    		...
	    		.addGroup(gl_panel_2.createSequentialGroup()
	    			...
	    			.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
	    				...
	    				.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
	    					...
	    					.addComponent(lekovitx_1_1_1, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)
	    					.addComponent(lekovitx_1_1_1_1, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)))
	    			.addGap(81)
	    			.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
